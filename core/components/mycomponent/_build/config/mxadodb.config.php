...
$packageNameLower = 'mxadodb'; /* No spaces, no dashes */
...
$components = array(
    ...
    'authorUrl' => 'http://www.ethannewmedia.com',
    'authorSiteName' => "Ethan New Media Inc.",
    ...
    'gitHubUsername' => 'enminc',
    'gitHubRepository' => 'mxADOdb',
    ...
    'newSystemSettings' => array(
        'mxadodb_dsn' => array( // key
            ...
            'namespace' => 'mxadodb',
            'xtype' => 'textfield',
            'value' => 'pdo_mysql://%username%:%password%@%host%/%db%?persist',
            'area' => 'Connection',
        ),
        'mxadodb_adodb' => array( // key
            ...
            'namespace' => 'mxadodb',
            'xtype' => 'textfield',
            'value' => '{"ADODB_FETCH_MODE":"ADODB_FETCH_NUM"}',
            'area' => 'Connection',
        ),
    ),
    ...
    */
    ...
    'namespaces' => array(
        'mxadodb' => array(
            'name' => 'mxadodb',
            'path' => '{core_path}components/mxadodb/',
            'assets_path' => '{assets_path}components/mxadodb/',
        ),
